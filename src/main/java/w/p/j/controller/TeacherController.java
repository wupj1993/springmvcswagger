...
public class TeacherController extends BaseController {
    ...
    public BaseResult getTeacherById(@ApiParam(name = "id",required = true,value = "Teacher by Id")@RequestParam("id")int id){
    ...
    public BaseResult getTeacherByName(@ApiParam(name = "name",required = true,value = "Teacher by name")@RequestParam("name")String name){
